...
if (!class_exists('Ovic_Cmb2_Image_Select_Field')){
    class Ovic_Cmb2_Image_Select_Field{
        ...
        public function enqueue_scripts(){
            wp_enqueue_style( 'image-select-metafield', BIANCO_TOOLKIT_PLUGIN_URL . 'includes/admin/settings/Extends/CMB2-Image_Select-Field-Type/image_select_metafield.css' );
            wp_enqueue_script( 'image-select-metafield', BIANCO_TOOLKIT_PLUGIN_URL . 'includes/admin/settings/Extends/CMB2-Image_Select-Field-Type/image_select_metafield.js' ,array( 'jquery' ) );
        }
