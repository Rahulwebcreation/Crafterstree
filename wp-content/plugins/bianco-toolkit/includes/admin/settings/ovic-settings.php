...
if ( !class_exists( 'Ovic_Settings' ) ) {
	class Ovic_Settings
	{
		...
		public function __construct()
		{
			...
			// Set our title
			$this->title = __( 'Theme Options', 'bianco-toolkit' );
		}
		...
		{
			require_once BIANCO_TOOLKIT_PLUGIN_DIR . 'includes/admin/settings/CMB2/init.php';
			require_once BIANCO_TOOLKIT_PLUGIN_DIR . 'includes/admin/settings/Extends/CMB2-Image_Select-Field-Type/image_select_metafield.php';
			require_once BIANCO_TOOLKIT_PLUGIN_DIR . 'includes/admin/settings/Extends/cmb-field-select2/cmb-field-select2.php';
			require_once BIANCO_TOOLKIT_PLUGIN_DIR . 'includes/admin/settings/Extends/cmb2-switch.php';
			require_once BIANCO_TOOLKIT_PLUGIN_DIR . 'includes/admin/settings/ovic-metabox.php';
			require_once BIANCO_TOOLKIT_PLUGIN_DIR . 'includes/admin/settings/contextual-help.php';
			require_once BIANCO_TOOLKIT_PLUGIN_DIR . 'includes/admin/settings/backup.php';
		}
		...
		{
			$active_tab     = isset( $_GET['tab'] ) ? sanitize_text_field( $_GET['tab'] ) : 'extends_options';
            ...
            <div class="wrap ovic-wrap-options <?php echo $this->key; ?>">
                <h2><?php esc_html_e( 'Ovic Settings', 'bianco-toolkit' ); ?></h2>
				...
				if ( $number_of_sections > 1 ) {
					echo '<div><ul class="subsubsub ovic-settings-sub-nav">';
					foreach ( $sections as $section ) {
						echo '<li>';
						$number++;
				...
				$args = array(
					'save_button' => esc_html__( 'Save Settings', 'bianco-toolkit' ),
	            ...
	            <div class="ovic-wrap">
            		<div id="tabs-container" role="tabpanel">
						...
						<?php echo apply_filters( 'ovic_settings_print_option_page', $html, $active_tab, $active_section ); ?>
						</div>
					</div>
				</div>
            </div>
		...
		public static function option_fields()
		{
			$options['extends_options'] = array(
				'id'         => 'extends_options',
				'title'      => __( 'Mailchip Settings', 'bianco-toolkit' ),
				'show_names' => true,
				'sections'   => array(),
			);
