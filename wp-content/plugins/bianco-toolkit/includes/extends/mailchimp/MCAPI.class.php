...
if ( !class_exists( 'OVIC_MCAPI' ) ) {
	class OVIC_MCAPI
	{
		...
		{
			$message .= '<br /><br />' . sprintf( '<a href="%s">' . __( 'Read more about common connectivity issues.', 'bianco-toolkit' ) . '</a>', 'https://kb.mc4wp.com/solving-connectivity-issues/#utm_source=wp-plugin&utm_medium=mailchimp-for-wp&utm_campaign=settings-notice' );
		...
		private function get_headers()
		{
			...
			$headers = array(
				...
				'User-Agent' => 'OVIC/' . BIANCO_TOOLKIT_VERSION . '; WordPress/' . $wp_version . '; ' . get_bloginfo( 'url' ),
			);
