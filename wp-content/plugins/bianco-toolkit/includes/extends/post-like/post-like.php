	...
	class Ovic_Post_Like
	{
		...
		function ovic_enqueue_scripts()
		{
			...
			wp_localize_script( 'ovic-post-like', 'simpleLikes', array(
					...
					'like'    => __( 'Like', 'bianco-toolkit' ),
					'unlike'  => __( 'Unlike', 'bianco-toolkit' ),
				)
			);
		}
		...
		function process_simple_like()
		{
			...
			if ( !wp_verify_nonce( $nonce, 'simple-likes-nonce' ) ) {
				exit( __( 'Not permitted', 'bianco-toolkit' ) );
			}
		...
		function ovic_simple_likes_button( $post_id, $is_comment = NULL )
		{
			...
			if ( $this->already_liked( $post_id, $is_comment ) ) {
				...
				$title_html    = '<span class="title">' . __( 'Liked', 'bianco-toolkit' ) . '</span>';
			} else {
				$class['like'] = '';
				$icon          = '<span class="icon">' . $icon_empty . '</span>';
				$title_html    = '<span class="title">' . __( 'Like', 'bianco-toolkit' ) . '</span>';
			}
		...
		function ovic_show_user_likes( $user_ID = null )
		{
            ...
            <table class="form-table">
                <thead>
                <tr>
                    <th><label for="user_likes"><?php _e( 'You Liked:', 'bianco-toolkit' ); ?></label></th>
                </tr>
                </thead>
                <tbody>
				<?php
				...
				if ( $like_query->have_posts() ) :
                    ...
                    <tr>
                        <td><?php _e( 'You do not like anything yet.', 'bianco-toolkit' ); ?></td>
                    </tr>
				<?php endif;
				wp_reset_postdata();
				?>
