...
if ( !class_exists( 'OVIC' ) ) {
	class OVIC
	{
		...
		public static function locate_template( $template, $load = true )
		{
			...
			} elseif ( file_exists( OVIC_PLUGIN_DIR . '/' . $template ) ) {
				$located = OVIC_PLUGIN_DIR . '/' . $template;
			}
			...
			if ( !$load ) {
				$located_dir = OVIC_PLUGIN_DIR . '/' . $template;
			}
		...
		public function constants()
		{
			...
			defined( 'OVIC_PLUGIN_DIR' ) or define( 'OVIC_PLUGIN_DIR', $directory . $foldername );
			defined( 'OVIC_PLUGIN_URL' ) or define( 'OVIC_PLUGIN_URL', $directory_uri . $foldername );
		}
