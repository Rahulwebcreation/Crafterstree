...
if( ! class_exists( 'OVIC_Field_background' ) ) {
  class OVIC_Field_background extends OVIC_Fields {
    ...
    public function output() {
      ...
      $button_title = ( isset( $button_title ) ) ? $button_title : __( 'Upload', 'bianco-toolkit' );
      $frame_title  = ( isset( $frame_title  ) ) ? $frame_title  : __( 'Upload', 'bianco-toolkit' );
      $insert_title = ( isset( $insert_title ) ) ? $insert_title : __( 'Use Image', 'bianco-toolkit' );
