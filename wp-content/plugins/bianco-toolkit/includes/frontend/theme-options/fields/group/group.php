...
if ( !class_exists( 'OVIC_Field_group' ) ) {
	class OVIC_Field_group extends OVIC_Fields
	{
		...
		public function output()
		{
			...
			$acc_title   = ( isset( $this->field['accordion_title'] ) ) ? $this->field['accordion_title'] : __( 'Adding', 'bianco-toolkit' );
			...
			echo '<div class="ovic-field ovic-text-right"><a href="#" class="button ovic-warning-primary ovic-cloneable-remove">' . __( 'Remove', 'bianco-toolkit' ) . '</a></div>';
			echo '</div>';
			echo '</div>';
			...
			echo '</div>';
			echo '<div class="ovic-cloneable-data" data-unique-id="' . $unique_id . '" data-limit="' . $limit . '">' . __( 'You can not add more than', 'bianco-toolkit' ) . ' ' . $limit . '</div>';
