...
if ( !class_exists( 'OVIC_Field_icon' ) ) {
	class OVIC_Field_icon extends OVIC_Fields
	{
		...
		public function output()
		{
			...
			echo '<a href="#" class="button button-primary ovic-icon-add">' . __( 'Add Icon', 'bianco-toolkit' ) . '</a>';
			echo '<a href="#" class="button ovic-warning-primary ovic-icon-remove' . $hidden . '">' . __( 'Remove Icon', 'bianco-toolkit' ) . '</a>';
