...
if ( !class_exists( 'OVIC_Field_upload' ) ) {
	class OVIC_Field_upload extends OVIC_Fields
	{
		...
		public function output()
		{
			...
			$button_title = ( !empty( $this->field['settings']['button_title'] ) ) ? $this->field['settings']['button_title'] : __( 'Upload', 'bianco-toolkit' );
			$frame_title  = ( !empty( $this->field['settings']['frame_title'] ) ) ? $this->field['settings']['frame_title'] : __( 'Upload', 'bianco-toolkit' );
			$insert_title = ( !empty( $this->field['settings']['insert_title'] ) ) ? $this->field['settings']['insert_title'] : __( 'Use Image', 'bianco-toolkit' );
