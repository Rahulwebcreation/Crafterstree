...
if ( !function_exists( 'ovic_validate_email' ) ) {
	function ovic_validate_email( $args )
	{
		...
		if ( !sanitize_email( $field_value ) ) {
			return __( 'Please write a valid email address!', 'bianco-toolkit' );
		}
	}
}
/**
...
if ( !function_exists( 'ovic_validate_numeric' ) ) {
	function ovic_validate_numeric( $args )
	{
		if ( !is_numeric( $args['value'] ) ) {
			return __( 'Please write a numeric data!', 'bianco-toolkit' );
		}
	}
}
/**
...
if ( !function_exists( 'ovic_validate_required' ) ) {
	...
	{
		if ( empty( $args['value'] ) ) {
			return __( 'Fatal Error! This field is required!', 'bianco-toolkit' );
		}
	}
}
/**
...
if ( !function_exists( 'ovic_customize_validate_email' ) ) {
	function ovic_customize_validate_email( $validity, $value, $wp_customize )
	{
		...
		if ( !sanitize_email( $value ) ) {
			$validity->add( 'required', __( 'Please write a valid email address!', 'bianco-toolkit' ) );
		}
...
if ( !function_exists( 'ovic_customize_validate_numeric' ) ) {
	...
	{
		if ( !is_numeric( $value ) ) {
			$validity->add( 'required', __( 'Please write a numeric data!', 'bianco-toolkit' ) );
		}
...
if ( !function_exists( 'ovic_customize_validate_required' ) ) {
	...
	{
		if ( empty( $value ) ) {
			$validity->add( 'required', __( 'Fatal Error! This field is required!', 'bianco-toolkit' ) );
		}
