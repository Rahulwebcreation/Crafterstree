		...
		public function __construct()
		{
			$array_settings           = apply_filters( 'ovic_filter_settings_widget_iconbox',
				array(
					...
					'ovic_title'   => array(
						'type'  => 'text',
						'title' => esc_html__( 'Title Icon', 'bianco-toolkit' ),
					),
					'ovic_content' => array(
						'type'     => 'textarea',
						'sanitize' => 'disabled',
						'title'    => esc_html__( 'Descriptions', 'bianco-toolkit' ),
					),
				)
			);
			$this->widget_cssclass    = 'widget-ovic-iconbox';
			$this->widget_description = esc_html__( 'Display the customer Iconbox.', 'bianco-toolkit' );
			$this->widget_id          = 'widget_ovic_iconbox';
			$this->widget_name        = esc_html__( 'Ovic: Iconbox', 'bianco-toolkit' );
