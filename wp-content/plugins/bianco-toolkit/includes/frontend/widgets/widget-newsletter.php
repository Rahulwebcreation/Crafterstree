		...
		public function __construct()
		{
			$array_settings           = apply_filters( 'ovic_filter_settings_widget_mailchimp',
				array(
					...
					'description' => array(
						'type'  => 'textarea',
						'title' => esc_html__( 'Description:', 'bianco-toolkit' ),
					),
					'background'  => array(
						'type'  => 'image',
						'title' => esc_html__( 'Background:', 'bianco-toolkit' ),
					),
					'show_list'   => array(
						'type'       => 'select',
						'title'      => esc_html__( 'Show Mailchimp List', 'bianco-toolkit' ),
						'options'    => array(
							'yes' => esc_html__( 'Yes', 'bianco-toolkit' ),
							'no'  => esc_html__( 'no', 'bianco-toolkit' ),
						),
						'default'    => 'no',
						'attributes' => array(
							'style' => 'width: 100%',
					...
					'field_name'  => array(
						'type'       => 'select',
						'title'      => esc_html__( 'Show Field Name', 'bianco-toolkit' ),
						'options'    => array(
							'yes' => esc_html__( 'Yes', 'bianco-toolkit' ),
							'no'  => esc_html__( 'no', 'bianco-toolkit' ),
						),
					...
					'fname_text'  => array(
						'type'       => 'text',
						'default'    => esc_html__( 'First Name', 'bianco-toolkit' ),
						'dependency' => array( 'field_name', '==', 'yes' ),
						'title'      => esc_html__( 'First Name Text:', 'bianco-toolkit' ),
					),
					'lname_text'  => array(
						'type'       => 'text',
						'default'    => esc_html__( 'Last Name', 'bianco-toolkit' ),
						'dependency' => array( 'field_name', '==', 'yes' ),
						'title'      => esc_html__( 'Last Name Text:', 'bianco-toolkit' ),
					),
					'placeholder' => array(
						'type'    => 'text',
						'title'   => esc_html__( 'Placeholder Text:', 'bianco-toolkit' ),
						'default' => esc_html__( 'Your email letter', 'bianco-toolkit' ),
					),
					'button_text' => array(
						'type'    => 'text',
						'title'   => esc_html__( 'Button Text:', 'bianco-toolkit' ),
						'default' => esc_html__( 'Subscribe', 'bianco-toolkit' ),
					),
				)
			);
			$this->widget_cssclass    = 'widget-ovic-mailchimp';
			$this->widget_description = esc_html__( 'Display the customer Newsletter.', 'bianco-toolkit' );
			$this->widget_id          = 'widget_ovic_mailchimp';
			$this->widget_name        = esc_html__( 'Ovic: Newsletter', 'bianco-toolkit' );
