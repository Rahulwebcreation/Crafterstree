	...
	class Recent_Blog_Widget extends WP_Widget
	{
					...
					<?php while ( $loop_posts->have_posts() ) : $loop_posts->the_post() ?>
						<article <?php post_class( 'blog-item' ); ?>>
							...
							<div class="post-info">
								...
								<div class="post-meta">
									<span class="author"><span><?php echo esc_html__( 'By', 'bianco' ); ?></span> <?php the_author() ?></span> -
									<span class="date"><?php echo get_the_date('D, F j.'); ?></span>
								</div>
							</div>
						</article>
					<?php endwhile; ?>
		...
		function form( $instance )
		{
			...
			$choose_post_field = array(
				...
				'title'      => esc_html__( 'Choose Type Post', 'bianco' ),
			);
			...
			$ids_field = array(
				...
				'title'      => esc_html__( 'Search by name Post', 'bianco' ),
			);
			...
			$category_field = array(
				...
				'title'      => esc_html__( 'Category', 'bianco' ),
			);
			...
			$type_post_field = array(
				...
				'dependency' => array( 'choose_post', '==', '0' ),
				'title'      => esc_html__( 'Sort By', 'bianco' ),
			);
			...
			$number_field = array(
				...
				'dependency' => array( 'choose_post', '==', '0' ),
				'title'      => esc_html__( 'Number Post', 'bianco' ),
			);
