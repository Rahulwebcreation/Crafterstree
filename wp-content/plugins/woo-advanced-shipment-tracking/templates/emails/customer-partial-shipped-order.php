...
$email_content = get_theme_mod('wcast_partial_shipped_email_content',$wcast_partial_shipped_customizer_settings->defaults['wcast_partial_shipped_email_content']);
