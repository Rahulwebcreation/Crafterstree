...
$email_content = get_theme_mod('wcast_updated_tracking_email_content',$wcast_updated_tracking_customizer_settings->defaults['wcast_updated_tracking_email_content']);
