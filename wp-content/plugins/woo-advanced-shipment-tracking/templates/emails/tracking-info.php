...
if ( $tracking_items ) : 
	...
	$select_tracking_template = get_theme_mod('select_tracking_template');

	$show_provider_th = 1;	
	$colspan = 1;
	$display_thumbnail = get_theme_mod('display_shipment_provider_image');
	$display_shipping_provider_name = get_theme_mod('display_shipment_provider_name');
	$tracking_number_link = get_theme_mod('tracking_number_link');	
	...
	} elseif(get_theme_mod('header_content_text_align')){
		$header_content_text_align = get_theme_mod('header_content_text_align');
	}
	...
	$email_table_backgroud_color = get_theme_mod('table_bg_color','#ddd');
	...
	if(get_theme_mod('table_header_font_size')){ $table_header_font_size = get_theme_mod('table_header_font_size','12'); }
	...
	if(get_theme_mod('table_content_font_size')){ $table_content_font_size = get_theme_mod('table_content_font_size','12'); }
	
	if($table_content_font_size == ''){
		$table_content_font_size = '12';
	}
	if($table_header_font_size == ''){
			...
			?>	
				<li class="tracking_list_li">
					<div class="tracking_list_div" style="font-size:<?php echo $simple_provider_font_size; ?>px;color:<?php echo $simple_provider_font_color; ?>;border-bottom:<?php echo $show_provider_border; ?>px solid <?php echo $provider_border_color; ?>">
						<?php echo apply_filters( 'ast_provider_title', esc_html( $tracking_item['formatted_tracking_provider'] )); ?> - <a href="<?php echo esc_url( $url ); ?>" target="_blank"><?php echo esc_html( $tracking_item['tracking_number'] ); ?></a>
					</div>
