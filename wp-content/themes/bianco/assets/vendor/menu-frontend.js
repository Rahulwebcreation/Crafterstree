;(function ($) {
    ...
    .on('click', '.ovic-menu-clone-wrap .ovic-menu-close-panels', function (e) {
        $('.ovic-menu-clone-wrap').removeClass('open');
        e.preventDefault();
    })
    .on('click', '.ovic-menu-next-panel', function (e) {
        // Open next panel
        var $this     = $(this),
    ...
    .on('click', '.ovic-menu-prev-panel', function (e) {
    ...
    .on('click', '.block-title', function (e) {
        // Open vartical menu
        e.preventDefault();
