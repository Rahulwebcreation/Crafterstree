...
if ( $text_3 )
    $text_3 = '<b class="text-3">' . esc_html( $text_3 ) . '</b>';
if ( $text_4 )
    $text_4 = '<span class="text-4">' . esc_html( $text_4 ) . '</span>';
if ( $text_5 )
    $text_5 = '<span class="text-5">' . esc_html( $text_5 ) . '</span>';
if( $text_3 || $text_4 || $text_5 ){
    $html_group_texts .="<div class='discount-scr'>{$text_3}<div class='index'>{$text_4}{$text_5}</div></div>";
}
if ( $link['title'] ) {
...
<div class="inner-content">
    ...
    <div class="thumb-banner">
        <a class="wrap-img"
           style="height: <?php echo esc_attr($image['height']);?>px; width: 100%; max-width:100%; background-position:center center; background-image: url(<?php echo esc_attr($image['url']);?>);"
