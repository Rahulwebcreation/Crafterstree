...
$html_group_texts = '';
if ($text_3)
    $text_3 = '<span class="text-3">'.esc_html($text_3).'</span>';
if ($text_4)
    $text_3 .= '<span class="text-4">'.esc_html($text_4).'</span>';
if ( $text_1)
    $html_group_texts .= '<span class="text-1">' . esc_html( $text_1 ) . '</span>';
if ($text_2)
    $html_group_texts .= '<b class="text-2">' . esc_html( $text_2 ). '</b>';
if ($text_3)
    $html_group_texts .= '<span class="text-2af">' .wp_specialchars_decode( $text_3). '</span>';
if ($text_5)
