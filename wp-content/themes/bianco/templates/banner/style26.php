...
$image = $atts['image'] ? apply_filters( 'ovic_resize_image', $atts['image'], false, false, true, true ) : array(
    ...
    'width'     => 370,
    'height'    => 326,
    'img'       => '<img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAACCAYAAACZgbYnAAAAE0lEQVQImWP4////f4bLly//BwAmVgd1/w11/gAAAABJRU5ErkJggg==" alt="bianco placeholder">',
);
...
<div class="inner-content">
    ...
    <?php if ( $text_3 ): ?>
        <span class="text-foot"><?php echo esc_html( $text_3 ); ?></span>
    <?php endif; ?>
</div>