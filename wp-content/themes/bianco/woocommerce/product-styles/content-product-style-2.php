...
?>
<div class="product-inner st2 btn-hover-main">
    ...
    <?php
    /**
     * bianco_show_product_loop_sale_flash hook.
     *
     * @hooked bianco_show_product_loop_sale_flash - 10
     */
        do_action('bianco_show_product_group_flash');
    ?>
